...
(57, 0, 0, 'Street Suffix', 'text', NULL, 1, '1', 0, 1, 0, 1, 1, 14.0000, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 'wpl_properties', 'street_suffix', 2, 1, 0, NULL, '1', NULL, NULL, 1);
...
(24, '[0][1][2][4]', 'array', 1, 1.00, 'ALTER TABLE `#__[TABLE_NAME]` ADD `field_[FIELD_ID]` text NULL; UPDATE `#__wpl_dbst` SET `table_name`=''[TABLE_NAME]'', `table_column`=''field_[FIELD_ID]'' WHERE id=[FIELD_ID];', 'ALTER TABLE `#__[TABLE_NAME]` DROP `field_[FIELD_ID]`;', NULL);
...
DELETE FROM `#__wpl_extensions` WHERE `id`='115';
DELETE FROM `#__wpl_extensions` WHERE `id`='117';
DELETE FROM `#__wpl_extensions` WHERE `id`='118';
DELETE FROM `#__wpl_extensions` WHERE `id`='103';
DELETE FROM `#__wpl_extensions` WHERE `id`='104';
DELETE FROM `#__wpl_extensions` WHERE `id`='108';
...
DELETE FROM `#__wpl_extensions` WHERE `id`='110';
DELETE FROM `#__wpl_extensions` WHERE `id`='114';
...
ALTER TABLE `#__wpl_users` ENGINE = MyISAM;
...
INSERT INTO `#__wpl_dbst` (`id`, `kind`, `mandatory`, `name`, `type`, `options`, `enabled`, `pshow`, `pdf`, `plisting`, `searchmod`, `editable`, `deletable`, `index`, `css`, `style`, `specificable`, `listing_specific`, `property_type_specific`, `user_specific`, `accesses`, `accesses_message`, `table_name`, `table_column`, `category`, `rankable`, `rank_point`, `comments`, `pwizard`, `text_search`, `params`, `flex`) VALUES
(59, 0, 0, 'Zipcode', 'text', '', 1, '0', 0, 0, 1, 0, 0, 2.06, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'wpl_properties', 'zip_name', 2, 1, 0, NULL, '0', 1, NULL, 1);