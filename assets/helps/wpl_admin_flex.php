...
$content = '<h3>'.__('WPL Fle', 'wpl').'</h3><p>'.__('With this menu you can manage WPL fields. You can add new fields, manage existing ones, and sort based on your personal preferences. ', 'wpl').'</p>';
