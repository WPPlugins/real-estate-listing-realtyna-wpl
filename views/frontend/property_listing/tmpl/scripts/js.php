...
function wpl_listing_set_js_triggers()
{
    ...
    wplj(document).on('click', '#list_view', function()
    {
        ...
        wplj('.wpl_property_listing_listings_container').fadeOut("slow",function()
        {
			...
			wplj(this).removeClass('wpl-large-up-<?php echo $this->listing_columns; ?>').removeClass('wpl-medium-up-2').removeClass('wpl-small-up-1');
    ...
    wplj(document).on('click', '#grid_view', function()
    {
        ...
        wplj('.wpl_property_listing_listings_container').fadeOut("slow",function()
        {
            ...
            wplj(this).addClass('wpl-large-up-<?php echo $this->listing_columns; ?>').addClass('wpl-medium-up-2').addClass('wpl-small-up-1');
            wplj(this).fadeIn("slow");
    ...
    wplj(document).on('click', '#map_view', function()
    {
        ...
        wplj('.wpl_property_listing_container').fadeOut("slow",function()
        {
            wpl_fix_no_image_size();
