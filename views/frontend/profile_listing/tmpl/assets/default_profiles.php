    ...
    <div class="wpl-column">
      <div <?php echo $this->itemscope.' '.$this->itemtype_RealEstateAgent; ?> class="wpl_profile_container <?php echo (isset($this->property_css_class) ? $this->property_css_class : ''); ?>" id="wpl_profile_container<?php echo $profile['data']['id']; ?>">
          ...
          <ul>
              ...
              <li <?php echo $this->itemprop_telephone; ?> class="phone"><?php echo $profile['materials']['tel']['value']; ?>
              ...
              <li <?php echo $this->itemprop_telephone; ?> class="mobile"><?php echo $profile['materials']['mobile']['value']; ?>
              ...
              <li <?php echo $this->itemprop_faxNumber; ?> class="fax wpl-tooltip-top"><?php echo $profile['materials']['fax']['value']; ?></li>
