...
<div class="wpl-links-req-visit-wp" id="wpl_form_adding_price_request_container">
    <form class="wpl-gen-form-wp" id="adding_price_request_form" onsubmit="adding_price_request_submit(); return false;" novalidate="novalidate">
        <div class="wpl-gen-form-row">
            <label for="wpl-links-price-req-name"><?php echo __('Name', 'wpl'); ?></label>
            <input type="text" name="wplfdata[name]" id="wpl-links-price-req-name" placeholder="<?php echo __('Name', 'wpl'); ?>" />
        </div>
        <div class="wpl-gen-form-row">
            <label for="wpl-links-price-req-email"><?php echo __('Email', 'wpl'); ?></label>
            <input type="email" name="wplfdata[email]" id="wpl-links-price-req-email" placeholder="<?php echo __('Email', 'wpl'); ?>" />
        </div>
        <div class="wpl-gen-form-row">
            <label for="wpl-links-price-req-tel"><?php echo __('Phone', 'wpl'); ?></label>
            <input type="tel" name="wplfdata[tel]" id="wpl-links-price-req-tel" placeholder="<?php echo __('Tel', 'wpl'); ?>" />
        </div>
