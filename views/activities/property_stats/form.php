...
?>
<div class="fanc-row">
    <label for="wpl_contacts"><?php echo __('Contact', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_including_in_listing"><?php echo __('Including in listing page', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_view_parent"><?php echo __('View parent', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_visit"><?php echo __('Visit', 'wpl'); ?></label>
