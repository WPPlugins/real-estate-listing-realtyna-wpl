...
?>
<div class="fanc-row">
    <label for="wpl_o_picture_width"><?php echo __('Picture width', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_picture_height"><?php echo __('Picture height', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_mailto"><?php echo __('Mailto:', 'wpl'); ?></label>
    ...
    <span class="gray_tip"><?php echo __('Sending emails directly', 'wpl'); ?></span>
</div>