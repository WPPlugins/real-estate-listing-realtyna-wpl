...
?>
<div class="fanc-row">
    <label for="wpl_o_chart_background"><?php echo __('Chart Background', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_chart_title"><?php echo __('Chart Title', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_chart_width"><?php echo __('Chart Width', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_chart_height"><?php echo __('Chart Height', 'wpl'); ?></label>
...
<div class="fanc-row">
    <label for="wpl_o_data"><?php echo __('Chart Data', 'wpl'); ?></label>
    <input class="text_box" name="option[data]" type="text" id="wpl_o_data" value="<?php echo isset($this->options->data) ? stripslashes($this->options->data) : "[['Sony',7], ['Samsumg',13.3], ['LG',14.7], ['Vizio',5.2], ['Insignia', 1.2]]"; ?>" title="<?php echo __('Insert rendered string (For developers)', 'wpl'); ?>" />
</div>