...
<div class="fanc-content size-width-1">
    <h2><?php echo ($this->location_id ? __('Edit location', 'wpl') : __('Add location', 'wpl')); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="wpl_location_name"><?php echo __('Name', 'wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label for="wpl_location_abbr"><?php echo __('Abbreviation', 'wpl'); ?></label>
        ...
        <div class="fanc-row fanc-button-row">
            <?php if ($this->location_id): ?>
                ...
                <input class="wpl-button button-1" type="submit" id="wpl_submit" value="<?php echo __('Save', 'wpl'); ?>" onclick="wpl_ajax_modify_location('<?php echo $this->level; ?>', '', '<?php echo $this->location_id; ?>');" />
            <?php else: ?>
                <input class="wpl-button button-1" type="submit" id="wpl_submit" value="<?php echo __('Save', 'wpl'); ?>" onclick="wpl_ajax_modify_location('<?php echo $this->level; ?>', '<?php echo $this->parent; ?>');" />
            <?php endif; ?>
