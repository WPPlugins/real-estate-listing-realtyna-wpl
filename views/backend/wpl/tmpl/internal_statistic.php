...
<div class="side-6 side-statistic1">
    <div class="panel-wp">
        <h3><?php echo __('Properties by listing types', 'wpl'); ?></h3>
        <div class="panel-body">
        	<?php
				...
				foreach($properties as $property)
				{
                    ...
                    {
                        $data[__($listing->name, 'wpl')] = $property['count'];
				...
				if(count($data))
                {
                    echo '<div class="wpl-total-properties">'.sprintf(__('Total Properties: %s', 'wpl'), $total).'</div>';
                    wpl_global::import_activity('charts:bar', '', $params);
                }
				else echo __('No data!', 'wpl');
			?>
        </div>
    </div>
</div>
<div class="side-6 side-statistic2">
    <div class="panel-wp">
        <h3><?php echo __('Properties by property types', 'wpl'); ?></h3>
        <div class="panel-body">
        	<?php
				...
				foreach($properties as $property)
				{
                    ...
                    {
                        $data[__($property_type->name, 'wpl')] = $property['count'];
                        $total += $property['count'];
                    }
				}
