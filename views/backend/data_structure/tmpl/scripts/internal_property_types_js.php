...
function wpl_remove_ptcategory(id, confirmed)
{
    ...
    if(!confirmed)
	{
		var message = "<?php echo addslashes(__('Are you sure you want to remove this item?', 'wpl')); ?>&nbsp;(<?php echo addslashes(__('ID', 'wpl')); ?>:"+id+")&nbsp;";
		message += '<span class="wpl_actions" onclick="wpl_remove_ptcategory(\''+id+'\', 1);"><?php echo addslashes(__('Yes', 'wpl')); ?></span>&nbsp;<span class="wpl_actions" onclick="wpl_remove_message();"><?php echo addslashes(__('No', 'wpl')); ?></span>';
