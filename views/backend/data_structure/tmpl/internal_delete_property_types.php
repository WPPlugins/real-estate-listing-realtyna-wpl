...
<div class="fanc-content size-width-1" id="wpl_delete_listing_property_type_cnt">
    <h2><?php echo __('Removing property type', 'wpl') . ' ' . __($this->property_type_data->name, 'wpl'); ?></h2>
    ...
    <div class="fanc-body wpl-del-options" id="pt-del-options">
        ...
        <div onclick="show_opt_2_property_type()" id="option_2" class="button button-primary button-large wpl-assign">
            <?php echo __('Assign to another property type', 'wpl'); ?>
        </div>
    </div>

    <div class="fanc-body hidden" id="pt-del-plist">
        <div class="fanc-row fanc-button-row-2">
            <input class="wpl-button button-1" type="button" value="<?php echo __('Assign', 'wpl'); ?>" onclick="assign_properties_property_type(<?php echo $this->property_type_id; ?>);" />
        </div>
        <div class="fanc-row">
            <label for="property_type_select"><?php echo __('Property Type', 'wpl'); ?></label>
