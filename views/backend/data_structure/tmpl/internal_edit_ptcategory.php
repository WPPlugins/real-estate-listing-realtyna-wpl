...
<div class="fanc-content size-width-1">
    <h2><?php echo (isset($this->ptcategory_data->name) ? $this->ptcategory_data->name : __('Add new category', 'wpl')); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="wpl_title<?php echo $this->ptcategory_id; ?>"><?php echo __('Name', 'wpl'); ?></label>
        ...
        <div class="fanc-row">
            <label></label>
            <input type="button" class="wpl-button button-1" onclick="wpl_ajax_insert_ptcategory(<?php echo $this->ptcategory_id; ?>);" value="<?php echo __('Save', 'wpl'); ?>"/>
        </div>
		<?php endif; ?>
