...
class wpl_data_structure_controller extends wpl_controller
{
    ...
    public function remove_ptcategory()
    {
        ...
        {
            $res = 0;
            $message = sprintf(__('There are %s assigned property types. Please remove them or assign them to another category first.', 'wpl'), '<strong>'.$has_property_types.'</strong>');
        }
        else
        {
            // Remove the category
            ...
            $res = 1;
            $message = __('The category removed.', 'wpl');
        }
