        ...
        <div class="wpl-side-2 side-tabs-wp">
            <ul>
                <?php if(in_array($this->kind, $this->dbcat_manager_kinds)): ?>
                    <li><a data-id="0" href="#0" class="wpl_slide_label wpl_slide_label_prefix_m" id="wpl_slide_label_id0" onclick="rta.internal.slides.open('0', '.side-tabs-wp', '.wpl_slide_container', 'currentTab');"><?php echo __('Category Management', 'wpl'); ?></a></li>
                <?php endif; ?>
                <?php foreach ($this->field_categories as $category): if($category->enabled==1): ?>
				    <li data-id="<?php echo $category->id; ?>"><a href="#<?php echo $category->id; ?>" class="wpl_slide_label wpl_slide_label_prefix_<?php echo $category->prefix; ?>" id="wpl_slide_label_id<?php echo $category->id; ?>" onclick="rta.internal.slides.open('<?php echo $category->id; ?>', '.side-tabs-wp', '.wpl_slide_container', 'currentTab');"><?php echo __($category->name, 'wpl'); ?></a></li>
                ...
                <?php if(in_array($this->kind, $this->dbcat_manager_kinds)): ?>
                    <div class="wpl_slide_container" id="wpl_slide_container_id0">
                        <table class="widefat page" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th><?php echo __('Category Name', 'wpl'); ?></th>
                                    <th colspan="5"></th>
                                </tr>
                            </thead>
