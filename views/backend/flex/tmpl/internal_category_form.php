...
<div class="fanc-content size-width-1">
    <h2><?php echo isset($this->category) ? __('Edit Category', 'wpl') : __('Add Category', 'wpl'); ?></h2>
    <div class="wpl_show_message" id="wpl_category_form_message"></div>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="category_name"><?php echo __('Name','wpl'); ?></label>
        ...
        <div class="fanc-row fanc-button-row">
            ...
            <input class="wpl-button button-1" onclick="wpl_save_category('<?php echo isset($this->category) ? $this->category->id : ''; ?>')" value="<?php echo __('Save','wpl'); ?>" type="button">
        </div>
    </div>
</div>