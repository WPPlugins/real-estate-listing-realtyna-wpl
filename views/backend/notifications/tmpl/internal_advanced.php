...
<div class="noti-advance-wp">
    ...
    <section class="wpl-outer">
        <header>
            <aside class="wpl-left">
                <?php echo __('Available users', 'wpl'); ?>
            </aside>
            <aside class="wpl-center">
                <div id="loading_additional_recipients"></div>
            </aside>
            <aside class="wpl-right">
                <?php echo __('Included users', 'wpl'); ?>
            </aside>
        </header>
        <section>
            <aside class="wpl-left">
    ...
    <section class="wpl-outer">
        <header>
            <aside class="wpl-left">
                <?php echo __('Email address', 'wpl'); ?>
            </aside>
            <aside class="wpl-center">
                <div id="loading_email_recipients"></div>
            </aside>
            <aside class="wpl-right">
                <?php echo __('Included emails', 'wpl'); ?>
            </aside>
        </header>
        <section>
            <aside class="wpl-left">
