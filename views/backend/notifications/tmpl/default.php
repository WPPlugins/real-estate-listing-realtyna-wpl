...
<div class="wrap wpl-wp">
    <header>
        ...
        <h2><?php echo __('Notifications', 'wpl'); ?></h2>
    </header>
    ...
    <div class="sidebar-wp">
        <div class="notification_top_bar">
            <div class="wpl_left_section">
                <input type="text" name="notification_filter" id="notification_filter" placeholder="<?php echo __('Filter', 'wpl'); ?>" autocomplete="off" />
            </div>
        ...
        <table class="widefat page" id="wpl_notification_table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="manage-column"><?php echo __('Subject', 'wpl'); ?></th>
                    <th scope="col" class="manage-column"><?php echo __('Description', 'wpl'); ?></th>
                    <th></th>
                    <th scope="col" class="manage-column"><?php echo __('Email', 'wpl'); ?></th>
                    <!-- Check SMS add-on is installed -->
                    <?php if(wpl_global::check_addon('sms')): ?>
                    <th scope="col" class="manage-column"><?php echo __('SMS', 'wpl'); ?></th>
                    <?php endif; ?>
                </tr>
            </thead>
            <tbody>
