...
<form action="#" id="wpl_notification_form">
    <div class="wrap wpl-wp pwizard-wp">
        <header>
            ...
            <h2><?php echo __('Edit Notification', 'wpl'); ?> (<?php echo $this->notification->subject; ?>) <span class="ajax-inline-save" id="wpl_modify_ajax_loader"></span></h2>
        </header>
