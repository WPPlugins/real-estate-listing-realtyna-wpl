...
function wpl_generate_listing_stats()
{
    request_str = 'wpl_format=b:listings:ajax&wpl_function=generate_listing_stats&_wpnonce=<?php echo $this->nonce; ?>';;
    ...
    wplj.ajax(
    {
        ...
        {
            wplj("#wpl_listing_stats_div").html(data);
        },
