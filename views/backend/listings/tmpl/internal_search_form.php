                ...
                <div class="prow">
                    ...
                    <div class="wpl_listing_manager_search_form_element_cnt">
                        <select name="sf_select_listing" id="sf_select_listing">
                            ...
                            <?php foreach ($this->listings as $listing): ?>
                                <option value="<?php echo $listing['id']; ?>" <?php echo($current_value == $listing['id'] ? 'selected="selected"' : ''); ?>><?php echo __($listing['name'], 'wpl'); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="wpl_listing_manager_search_form_element_cnt">
                        <select name="sf_select_property_type" id="sf_select_property_type">
                            ...
                            <?php foreach ($this->property_types as $property_type): ?>
                                <option value="<?php echo $property_type['id']; ?>" <?php echo($current_value == $property_type['id'] ? 'selected="selected"' : ''); ?>><?php echo __($property_type['name'], 'wpl'); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                        ...
                        <div class="wpl_listing_manager_search_form_element_cnt">
                            <select name="sf_select_user_id" id="sf_select_user_id">
                                ...
                                <?php foreach ($this->users as $user): ?>
                                    <option value="<?php echo $user->ID; ?>" <?php echo($current_value == $user->ID ? 'selected="selected"' : ''); ?>><?php echo __($user->user_login, 'wpl'); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="wpl_listing_manager_search_form_element_cnt">
                        <select name="sf_select_confirmed" id="sf_select_confirmed">
                            ...
                            <option value="1" <?php echo($current_value == '1' ? 'selected="selected"' : ''); ?>><?php echo __('Confirmed', 'wpl'); ?></option>
                            <option value="0" <?php echo($current_value == '0' ? 'selected="selected"' : ''); ?>><?php echo __('Unconfirmed', 'wpl'); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="wpl_listing_manager_search_form_element_cnt">
                        <select name="sf_select_finalized" id="sf_select_finalized">
                            ...
                            <option value="1" <?php echo($current_value == '1' ? 'selected="selected"' : ''); ?>><?php echo __('Finalized', 'wpl'); ?></option>
                            <option value="0" <?php echo($current_value == '0' ? 'selected="selected"' : ''); ?>><?php echo __('Unfinalized', 'wpl'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="prow">
