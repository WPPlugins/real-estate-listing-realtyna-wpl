...
<div id="wpl_googlemap_widget_cnt<?php echo $this->widget_id; ?>" class="wpl-googlemap-widget <?php echo $this->css_class; ?>">
    ...
    <div class="wpl-googlemap-widget-link">
        ...
        <a href="<?php echo wpl_global::add_qs_var('wplpcc', 'map_box', wpl_global::add_qs_var('wplfmap', '1', $listings_page)); ?>"><?php echo __('Map View', 'wpl'); ?></a>
        <?php else: ?>
        <a href="<?php echo wpl_global::add_qs_var('wplfmap', '1', $listings_page); ?>"><?php echo __('Map View', 'wpl'); ?></a>
        <?php endif; ?>
