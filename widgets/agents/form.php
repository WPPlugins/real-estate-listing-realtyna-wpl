...
<div class="wpl_agents_widget_backend_form wpl-widget-form-wp" id="<?php echo $this->get_field_id('wpl_agents_widget_container'); ?>">
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('titlew'); ?>"><?php echo __('Title', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_mailto_status'); ?>"><?php echo __('Mailto Status', 'wpl'); ?></label>
