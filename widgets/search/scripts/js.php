<script type="text/javascript">
    ...
    function wpl_do_search_<?php echo $this->widget_id; ?>() {
        ...
        <?php
			$search_page = $this->get_target_page((isset($target_id) ? $target_id : NULL));
			
			/** apply filters **/
			_wpl_import('libraries.filters');
			@extract(wpl_filters::apply('search_widget_search_page', array('search_page'=>$search_page, 'target_id'=>$target_id)));
		?>
