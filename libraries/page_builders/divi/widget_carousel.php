...
class wpl_page_builders_divi_widget_carousel extends ET_Builder_Module
{
    ...
    {
        $this->name = __('WPL Carousel Widget', 'wpl');
    ...
    public function get_fields()
    {
        ...
        $fields['id'] = array(
            ...
            'description'     => esc_html__('Select your desired carousel widget to show. if there is no widget in the list, Please configure some in Appearance->Widgets menu. You can put them inside of WPL Hidden sidebar.', 'wpl'),
        );
