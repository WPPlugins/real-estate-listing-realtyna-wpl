...
class wpl_page_builders_divi_profile_show extends ET_Builder_Module
{
    ...
    {
        $this->name = __('Profile/Agent Show', 'wpl');
    ...
    public function get_fields()
    {
        ...
        foreach($profile_show_layouts as $profile_show_layout) $profile_show_layouts_options[$profile_show_layout] = esc_html__($profile_show_layout, 'wpl');
