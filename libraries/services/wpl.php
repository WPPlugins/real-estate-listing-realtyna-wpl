...
class wpl_service_wpl
{
    ...
    public function theme_compatibility()
    {
        ...
        if($current_theme == 'bridge')
        {
			...
			//temporary fix for bridge autocomplete issue/remove it after bridge theme fix the issue
            wp_deregister_script('jquery-ui-autocomplete');
     	    wp_dequeue_script('jquery-ui-autocomplete');
     	    
     	    wp_register_script('jquery-ui-autocomplete', 'http://cdn.bootcss.com/jqueryui/1.10.4/jquery.ui.autocomplete.min.js');
        }
