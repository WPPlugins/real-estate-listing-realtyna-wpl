...
<div class="fanc-row">
    ...
    <select id="<?php echo $__prefix; ?>specificable" name="<?php echo $__prefix; ?>specificable" onchange="wpl_flex_change_specificable(this.value, '<?php echo $__prefix; ?>');">
        ...
        <option value="3" <?php if(isset($values->user_specific) and trim($values->user_specific) != '') echo 'selected="selected"'; ?>><?php echo __('User type specific', 'wpl'); ?></option>
    </select>
