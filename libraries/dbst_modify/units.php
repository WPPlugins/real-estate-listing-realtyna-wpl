...
<div class="fanc-body">
	...
	<div class="col-wp">
		...
		<div class="col-fanc-right" id="wpl_flex_specific_options">
            ...
            <?php if(in_array($type, array('area', 'mmarea'))): ?>
            <div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_conversion"><?php echo __('Conversion', 'wpl'); ?></label>
                <select name="<?php echo $__prefix; ?>opt_conversion" id="<?php echo $__prefix; ?>opt_conversion">
                    <option <?php echo (isset($options['conversion']) and $options['conversion'] == 0) ? 'selected="selected"' : ''; ?> value="0"><?php echo __('Disabled', 'wpl'); ?></option>
                    <option <?php echo (isset($options['conversion']) and $options['conversion'] == 1) ? 'selected="selected"' : ''; ?> value="1"><?php echo __('Enabled', 'wpl'); ?></option>
                </select>
                <p><?php echo __('Convert high values to Acre and Hectare', 'wpl'); ?></p>
			</div>
            <?php endif; ?>
