...
<div class="fanc-body">
	...
	<div class="col-wp">
		...
		<div class="col-fanc-right" id="wpl_flex_specific_options">
            ...
            <div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_link_title"><?php echo __('Link title', 'wpl'); ?></label>
			...
			<div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_link_target"><?php echo __('Target', 'wpl'); ?></label>
                <select name="<?php echo $__prefix; ?>opt_link_target" id="<?php echo $__prefix; ?>opt_link_target">
                    <option <?php echo (isset($options['link_target']) and $options['link_target'] == '_blank') ? 'selected="selected"' : ''; ?> value="_blank"><?php echo __('New Window', 'wpl'); ?></option>
                    <option <?php echo (isset($options['link_target']) and $options['link_target'] == '_self') ? 'selected="selected"' : ''; ?> value="_self"><?php echo __('Current Window', 'wpl'); ?></option>
                </select>
			</div>
		</div>
	</div>
