...
<div class="fanc-body">
	...
	<div class="col-wp">
		...
		<div class="col-fanc-right" id="wpl_flex_specific_options">
            ...
            <div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_true_label"><?php echo __('True Label', 'wpl'); ?></label>
            ...
            <div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_false_label"><?php echo __('False Label', 'wpl'); ?></label>
            ...
            <?php if(!$dbst_id): ?>
            <div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_default_value"><?php echo __('Default Value', 'wpl'); ?></label>
                <select name="<?php echo $__prefix; ?>opt_default_value" id="<?php echo $__prefix; ?>opt_default_value">
                    <option value="1" <?php echo ((isset($options['default_value']) and $options['default_value'] == 1) ? 'selected="selected"' : ''); ?>><?php echo __('True', 'wpl'); ?></option>
                    <option value="0" <?php echo ((isset($options['default_value']) and $options['default_value'] == 0) ? 'selected="selected"' : ''); ?>><?php echo __('False', 'wpl'); ?></option>
                </select>
			</div>
            <?php endif; ?>
		</div>
