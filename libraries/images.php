...
class wpl_images
{
    ...
    public static function trim_white_spaces($src, $dest, $color = 0xFFFFFF)
    {
        ...
        if($fileExtension == 'gif') imagegif($newimg, $dest, $quality);
        else if($fileExtension == 'jpg') imagejpeg($newimg, $dest, $quality);
        else if($fileExtension == 'png') imagepng($newimg, $dest, $quality);
