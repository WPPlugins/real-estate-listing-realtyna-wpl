...
class wpl_locations
{
     ...
     * @return array
     */
	public static function get_locations($level = 1, $parent = '', $enabled = 0, $condition = '', $order_by = '`name` ASC', $limit = 150)
	{
		if(trim($condition) == '')
		{
			$condition = "";
		...
		$query = "SELECT * FROM `#__wpl_location".$level."` WHERE 1 ".$condition." ORDER BY ".$order_by." LIMIT ".str_replace(array('LIMIT', 'limit'), '', $limit);
